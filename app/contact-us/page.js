...
export const metadata = {
        title: `Contact Us | ${company.name} Dubai`,
        description:
                "Get in touch with Idrees Technical Services in Dubai for AC repair, electrical maintenance, painting, and CCTV installation. 24/7 emergency support available.",
        alternates: {
                canonical: `${company.website}/contact-us`,
        },
        openGraph: {
                title: `Contact Us | ${company.name} Dubai`,
                description:
                        "Get in touch with Idrees Technical Services in Dubai for AC repair, electrical maintenance, painting, and CCTV installation.",
                url: `${company.website}/contact-us`,
        },
};
        ...
        const contactCards = [
                {
                        title: "Email Us",
                        value: company.email,
                        secondaryValue: company.supportEmail,
                        subtitle: "EMAIL",
                        tag: "Write",
                ...
                },
                {
                        ...
                        secondaryValue: `+${company.whatsapp}`,
                        subtitle: "PHONE",
                        tag: "Call",
