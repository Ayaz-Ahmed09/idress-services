...
const acBrands = ["Samsung", "LG", "Daikin", "Carrier", "Mitsubishi", "Trane", "Gree", "Other"];
const acIssues = [
        "Not Cooling", "Water Leaking", "Strange Noise", "Bad Smell",
        "Won't Turn On", "Compressor Issue", "Remote Not Working", "General Maintenance",
];
                        ...
                        <div className="mx-auto max-w-3xl">
                                ...
                                <div className="mb-12 text-center reveal-section">
                                        ...
                                        <p className="mx-auto max-w-xl text-[var(--text-secondary)]">
                                                Book in 60 seconds. A certified technician will arrive at your doorstep.
                                        </p>
                                </div>
                                                        ...
                                                        <div className="flex items-center justify-between mb-3">
                                                                {steps.map((s, i) => (
                                                                        <div key={s} className="flex items-center gap-2">
                                                                                ...
                                                                                <span className={`hidden text-xs font-medium sm:block ${i <= step ? "text-[var(--text-primary)]" : "text-[var(--text-muted)]"}`}>
                                                                                        {s}
                                                                                </span>
                                                                        </div>
                                                                ))}
                                                ...
                                                {confirmed ? (
                                                        ...
                                                        <div className="flex flex-col items-center justify-center text-center py-8 animate-fade-in-up">
                                                                ...
                                                                <p className="text-[var(--text-secondary)] mb-2">
                                                                        A technician for your <span className="text-[var(--accent-cyan)] font-semibold">{selectedBrand}</span> AC will arrive on{" "}
                                                                        <span className="text-[var(--text-primary)] font-semibold">{selectedDate}</span> at{" "}
                                                                        <span className="text-[var(--text-primary)] font-semibold">{selectedTime}</span>.
                                                                </p>
                                                                <p className="text-sm text-[var(--text-muted)] mb-6">
                                                                        Booking reference: #{Math.random().toString(36).substring(2, 8).toUpperCase()}
                                                                </p>
                                                                <button
                                                                        onClick={handleReset}
                                                                                ...
                                                                                <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
                                                                                        {acBrands.map((brand) => (
                                                                                                <button
                                                                                                        ...
                                                                                                        className={`rounded-xl border px-4 py-3 text-sm font-medium transition-all duration-200 ${selectedBrand === brand
                                                                                ...
                                                                                <div className="grid grid-cols-2 gap-3">
                                                                                        {acIssues.map((issue) => (
                                                                                                <button
                                                                                                        ...
                                                                                                        className={`rounded-xl border px-4 py-3 text-sm font-medium text-left transition-all duration-200 ${selectedIssue === issue
                                                                                                                        ? "border-[var(--accent-cyan)] bg-[var(--accent-cyan-dim)] text-[var(--accent-cyan)]"
                                                                                                                        : "border-[var(--border-glass)] text-[var(--text-secondary)] hover:border-[var(--accent-cyan)]/30 hover:text-[var(--text-primary)]"
                                                                                                                }`}
                                                                                                >
                                                                                                ...
                                                                                                <div className="grid grid-cols-2 gap-2">
                                                                                                        {timeSlots.map((time) => (
                                                                                                                <button
                                                                                                                        ...
                                                                                                                        className={`rounded-lg border px-3 py-2 text-xs font-medium transition-all duration-200 ${selectedTime === time
                                                                                                                                        ? "border-[var(--accent-cyan)] bg-[var(--accent-cyan-dim)] text-[var(--accent-cyan)]"
                                                                        ...
                                                                        <div className="animate-fade-in-up">
                                                                                ...
                                                                                <div className="space-y-4 rounded-xl bg-[var(--bg-secondary)] p-5">
                                                                                        <div className="flex justify-between text-sm">
                                                                                                ...
                                                                                                <span className="text-[var(--text-primary)] font-medium">{selectedBrand}</span>
                                                                                        </div>
                                                                                        <div className="flex justify-between text-sm">
                                                                                                <span className="text-[var(--text-muted)]">Issue</span>
                                                                                                <span className="text-[var(--text-primary)] font-medium">{selectedIssue}</span>
                                                                                        </div>
                                                                                        <div className="flex justify-between text-sm">
                                                                                                <span className="text-[var(--text-muted)]">Date</span>
                                                                                                <span className="text-[var(--text-primary)] font-medium">{selectedDate}</span>
                                                                                        </div>
                                                                                        <div className="flex justify-between text-sm">
                                                                                                <span className="text-[var(--text-muted)]">Time</span>
                                                                                                <span className="text-[var(--text-primary)] font-medium">{selectedTime}</span>
                                                                                        </div>
                                                                                        <hr className="border-[var(--border-glass)]" />
                                                                                        <div className="flex justify-between text-sm">
                                                                                                <span className="text-[var(--text-muted)]">Estimated Cost</span>
                                                                                                <span className="text-[var(--accent-cyan)] font-bold">AED 150 - 350</span>
                                                                                        </div>
                                                                                </div>
                                                                        </div>
                                                                )}
