                ...
                <section id="services" className="relative py-24 px-6">
                        <div className="mx-auto max-w-7xl">
                                ...
                                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 lg:grid-rows-[auto_auto_auto] reveal-section">
                                                        ...
                                                        <div className="relative flex-1 min-h-[240px] rounded-xl bg-[var(--bg-secondary)] overflow-hidden md:min-h-[320px]">
                                                                ...
                                                                <svg className="absolute inset-0 w-full h-full opacity-10" xmlns="http://www.w3.org/2000/svg">
                                                                        <pattern id="grid" width="40" height="40" patternUnits="userSpaceOnUse">
                                                                                <line x1="0" y1="0" x2="0" y2="40" stroke="var(--accent-cyan)" strokeWidth="0.5" />
                                                                                <line x1="0" y1="0" x2="40" y2="0" stroke="var(--accent-cyan)" strokeWidth="0.5" />
                                                                        </pattern>
                                                                ...
                                                                <div className="absolute top-[55%] left-[60%] flex items-center gap-2">
                                                                        <span className="relative flex h-3 w-3">
                                                                                <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-[var(--accent-orange)] opacity-75" style={{ animationDelay: "0.5s" }} />
                                                                ...
                                                                <div className="absolute top-[75%] left-[20%] flex items-center gap-2">
                                                                        <span className="relative flex h-3 w-3">
                                                                                <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-green-400 opacity-75" style={{ animationDelay: "1s" }} />
                                                                ...
                                                                <svg className="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
                                                                        <path d="M120,80 Q200,150 280,200" fill="none" stroke="var(--accent-cyan)" strokeWidth="2" strokeDasharray="8,4" opacity="0.3" />
                                                                </svg>
                                                        </div>
                                                </div>
                                        </div>
                                        ...
                                        <div className="group relative overflow-hidden rounded-2xl p-6 transition-all duration-500 hover:border-[var(--accent-orange)]/30" style={{ background: "linear-gradient(135deg, rgba(255,95,31,0.08), rgba(26,26,46,0.6))", border: "1px solid rgba(255,95,31,0.15)" }}>
