    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 pb-16 px-6">
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          ...
          <div
            className="absolute inset-8 rounded-full border border-[var(--accent-cyan)]/5 animate-pulse-ring"
            style={{ animationDelay: "1s" }}
          />
          <div
            className="absolute inset-16 rounded-full border border-[var(--accent-orange)]/5 animate-pulse-ring"
        ...
        <div
          className="absolute bottom-32 left-[10%] w-1.5 h-1.5 rounded-full bg-[var(--accent-orange)] animate-float opacity-30"
          style={{ animationDelay: "3s" }}
        />
        <div
          className="absolute top-[40%] right-[8%] w-1 h-1 rounded-full bg-[var(--accent-cyan)] animate-float opacity-20"
      ...
      <div
        className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-[var(--bg-primary)] to-transparent pointer-events-none"
        aria-hidden="true"
      />
    </section>
  );
