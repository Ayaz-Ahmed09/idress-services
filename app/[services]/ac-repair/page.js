...
export const metadata = {
  ...
  keywords:
    "AC repair, air conditioning service, same-day repair, emergency AC repair, AC installation, AC maintenance",
  alternates: {
    canonical: "/ac-repair",
  },
  openGraph: {
...
export default function AcRepairPage() {
  ...
  const gradientClass =
    colorClass[serviceData.color] || "from-blue-600 to-cyan-500";
  return (
    <>
      <ServiceBreadcrumb serviceSlug="ac-repair" />
      <main className="min-h-screen">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-4">
              {[
                ...
                <div key={i} className="relative">
                  ...
                  {i < 3 && (
                    <div className="hidden md:block absolute top-1/2 -right-3 transform -translate-y-1/2 w-6 h-6 rounded-full bg-blue-600 border-4 border-white dark:border-gray-950 text-white text-xs flex items-center justify-center font-bold">
                      →
                    </div>
                  )}
                </div>
        ...
        {/* CTA Banner */}
        <section className="py-20 md:py-32 px-6 bg-gradient-to-r from-blue-600 to-cyan-500">
          <div className="max-w-4xl mx-auto text-center text-white">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Need Immediate AC Repair?
            </h2>
            <p className="text-xl text-white/90 mb-10 max-w-2xl mx-auto">
              Don't wait for your AC to get worse. Our technicians are available
              24/7 for emergency repairs.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/book?service=ac-repair"
                className="inline-flex items-center justify-center px-10 py-4 rounded-xl font-bold text-blue-600 bg-white hover:shadow-2xl hover:shadow-black/30 transition-all duration-300 hover:scale-105"
              >
