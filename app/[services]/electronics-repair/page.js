...
export const metadata = {
  ...
  keywords:
    "Electronics repair, home appliance repair, device repair, warranty service",
  alternates: {
...
export default function ElectronicsRepairPage() {
  ...
  const gradientClass =
    colorClass[serviceData.color] || "from-green-600 to-emerald-500";

  return (
    <>
      <ServiceBreadcrumb serviceSlug="electronics-repair" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-4">
              {[
                ...
                <div key={i} className="relative">
                  ...
                  {i < 3 && (
                    <div className="hidden md:block absolute top-1/2 -right-3 transform -translate-y-1/2 w-6 h-6 rounded-full bg-green-600 border-4 border-white dark:border-gray-950 text-white text-xs flex items-center justify-center font-bold">
                      →
                    </div>
                  )}
                </div>
        ...
        >
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href={`/book?service=electronics-repair`}
