...
}: TestimonialsProps) =>
{
  ...
  // Split testimonials into 3 columns directly (static generation)
  const column1 = normalizedTestimonials.filter((_, i) => i % 3 === 0);
  const column2 = normalizedTestimonials.filter((_, i) => i % 3 === 1);
  const column3 = normalizedTestimonials.filter((_, i) => i % 3 === 2);
