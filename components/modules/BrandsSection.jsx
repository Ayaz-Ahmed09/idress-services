...
export default function BrandsSection({ brands, gradient }) {
  ...
  return (
    <section className="relative py-16 md:py-24 px-6 bg-gray-900/50">
        ...
        >
          {brands.map((brand) => (
            <motion.div key={brand} variants={itemVariants} className="group">
              <div
                className={`relative p-4 rounded-xl border border-gray-700 bg-gray-800 hover:border-gray-600 transition-all duration-300 hover:shadow-lg text-center overflow-hidden`}
              >
                {/* Hover gradient */}
                <div
